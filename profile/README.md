...
The **Agent Passport System** is the open protocol that makes every agent accountable. Cryptographic identity, scoped delegation, earned reputation, gateway enforcement, 5-gate commerce, Merkle attribution, institutional governance. 127 modules. 2,884 tests. One npm install.
...
**84 core modules + 43 v2 constitutional modules = 127 total. 2,884 tests. Zero heavy dependencies. Running code. MCP server included.**
