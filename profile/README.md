...
|---------|------|---------|
| [agent-passport-system](https://github.com/aeoess/agent-passport-system) | SDK — 54 core modules + 32 v2 constitutional modules, 1656 tests, Ed25519 identity, delegation chains, cascade revocation, values floor, Merkle attribution, signed communication, policy engine, coordination, agentic commerce, ProxyGateway enforcement, E2E encrypted messaging, data lifecycle governance, Intent Network | `npm i agent-passport-system` |
...
**54 core modules + 32 v2 constitutional modules. 1656 tests. Zero heavy dependencies. Running code. MCP server included.**
