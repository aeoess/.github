...
|---------|------|---------|
| [agent-passport-system](https://github.com/aeoess/agent-passport-system) | SDK — 63 core + 32 v2 constitutional modules, 1843 tests. Ed25519 identity, delegation chains, cascade revocation, values floor, Merkle attribution, signed communication, policy engine, coordination, agentic commerce, ProxyGateway enforcement, E2E encrypted messaging, data lifecycle governance, Intent Network | `npm i agent-passport-system` |
...
**63 core modules + 32 v2 constitutional modules. 1843 tests. Zero heavy dependencies. Running code. MCP server included.**
