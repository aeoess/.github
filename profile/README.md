...
The **Agent Passport System** is the open protocol that makes every agent accountable. Cryptographic identity, scoped delegation, earned reputation, gateway enforcement, 4-gate commerce, Merkle attribution, institutional governance. 103 modules. 2,552 tests. One npm install.
