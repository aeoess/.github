...
|---------|------|---------|
| [agent-passport-system](https://github.com/aeoess/agent-passport-system) | TypeScript SDK, the canonical reference. 107 modules (84 core + 23 v2 constitutional), 4,097 tests. Identity, delegation chains, cascade revocation, values floor, policy engine, agentic commerce, gateway enforcement, attribution, data lifecycle governance | `npm i agent-passport-system` |
